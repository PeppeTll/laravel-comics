...
class ComicController extends Controller
{
  ...
  public function show($id)
  {
    ...
    // $detail si associa all'elemento con indice designato nella lista comicsData
    $detail = $comicsData[$id];
    // Controllo sui dati, se comicsData non è settato la navigazione si 
    // interrompe abort_if().
    abort_if(!isset($comicsData[$id]), 404);
    return view('comicsDetail')
      ->with('detail', $detail);
  }
}
